...
model ros_inverted_pendelum_demo
  ...
  ros_inverted_pendelum_controller ros_inverted_pendelum_controller1(internalMessagingPolicy = ROSPlug.Publisher.InternalMessagingPolicy.Only, training = false) annotation(Placement(visible = true, transformation(origin = {20, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ros_inverted_pendelum_relay ros_inverted_pendelum_relay1(internalMessagingPolicy = ROSPlug.Publisher.InternalMessagingPolicy.Only) annotation(Placement(visible = true, transformation(origin = {-20, 15}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
