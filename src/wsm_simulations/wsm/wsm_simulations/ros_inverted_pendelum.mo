...
model ros_inverted_pendelum
  ...
  ROSPlug.Readers.RealReader average_reward(path = "average_reward") annotation(Placement(visible = true, transformation(origin = {-25, 67.239}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  parameter Modelica.SIunits.Time period(min = Modelica.Constants.small, start = 0.01) = 0.15 "Sample period (sampleTriggerOffset.period)";
  ROSPlug.Readers.RealReader qvalue(path = "qvalue") annotation(Placement(visible = true, transformation(origin = {10, 75}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(subscriber1.message1, average_reward.messageInConnector1) annotation(Line(visible = true, origin = {-42.432, 55}, points = {{-8.033, -15}, {-0.043, -15}, {-0.043, 12.239}, {8.117, 12.239}}, color = {64, 64, 64}));
  connect(subscriber1.message1, explored_states.messageInConnector1) annotation(Line(visible = true, origin = {-42.3, 27.5}, points = {{-8.165, 12.5}, {0.09, 12.5}, {0.09, -12.5}, {7.985, -12.5}}, color = {64, 64, 64}));
  ...
  connect(subscriber1.message1, qvalue.messageInConnector1) annotation(Line(visible = true, origin = {-16.947, 69.367}, points = {{-33.518, -29.367}, {-25.552, -29.367}, {-25.552, 15.633}, {8.819, 15.633}, {8.819, 5.633}, {17.632, 5.633}}, color = {64, 64, 64}));
